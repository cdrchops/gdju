 ...
 *
 * @author vivaldi
 * @version $Id: LoadingObject.java,v 1.3 2007/04/04 19:50:20 vivaldi Exp $
 * @since Oct 12, 2006
 */
public class LoadingObject {
    ...
    private BasicGameStateNode nextState2;

    public LoadingObject(String name, Runnable primary, Runnable secondary, BasicGameStateNode nextState2) {
        this.name = name;
