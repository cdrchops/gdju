 ...
 *
 * @author vivaldi
 * @version $Id: TestLoadingGameState.java,v 1.2 2007/04/18 21:53:19 vivaldi Exp $
 * @since Oct 12, 2006
 */
public class TestLoadingGameState extends BaseGame {
     ...
     *
     * @see com.jme.app.AbstractGame#update(floatinterpolation)
     */
...
//        LoadingManager.getInstance().checkState("gameStart");
     ...
     * @param interpolation unused in this implementation
     *
     * @see com.jme.app.AbstractGame#render(floatinterpolation)
     */
    protected final void render(float interpolation) {
        ...
        sl.render(interpolation, display);
    }
...
//        LoadingManager.getInstance().runLoader("gameStart", background, border, overlay);
        ...
        sl.init(url, url2, new MyClassToLoad.MyResourceLoaderThread(), display);
        sl.run();
