...
public class CircleGauge extends BaseComponent {
    protected void drawJOGL(final GL gl) {
        ...
        Font.display(-25, 38, String.valueOf(heading));
...
//        for (int i = (int) nearestTen - 40; i <= 360; i += 5) {
            ...
            if (displayHeading % 10 == 0) {
                ...
                if (displayHeading % 30 == 0) {
                    ...
                    Font.display(fontx, radius - tickLength - bigFontSize, String.valueOf(tmp));
                } else {
                    if (displayHeading >= 100) {
                    ...
                    Font.display(fontx, radius - tickLength - littleFontSize, String.valueOf(tmp));
                }
