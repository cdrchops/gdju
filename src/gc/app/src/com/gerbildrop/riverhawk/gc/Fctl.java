...
/**
 * @author torr
 * @since Nov 20, 2007 - 2:22:49 PM
 */
public class Fctl extends BaseComponent {
    ...
    protected void drawJOGL(final GL gl) {
        ...
        Font.display(0.023f, 0.911f, "F/CTL");
        // Paint status area
        StatusArea.display();
        ...
        Font.display(0.461f, 0.365f, "RUD");
        ...
        Font.display(0.461f, 0.319f, "GBY");
        gl.glPushMatrix();
