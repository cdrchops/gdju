...
//todo: fix to allow multiple backgrounds
//todo: fix so that the stages of completion are customizable (percentage, text, image changing, etc)
//urls used instead of texture definitions

/**
 * @author vivaldi
 * @version $Id: BasicLoadingGameState.java,v 1.6 2007/04/04 14:29:02 vivaldi Exp $
 * @since Oct 12, 2006
 */
public class BasicLoadingGameState extends GameState implements Loader {
    ...
    public BasicLoadingGameState(URL imagePath) {
        this(100, imagePath);
    }

    public BasicLoadingGameState(int steps, URL imagePath) {
        this.steps = steps;
        current = 0;
        init(imagePath);
    }

    protected void init(URL imagePath) {
...
//        hudNode.setRenderState(loading.getTextureState());
    ...
    class LoaderFadeOut extends TimedLifeController {
        ...
        public LoaderFadeOut(float lifeInSeconds, BasicLoadingGameState loading) {
            super(lifeInSeconds);
    ...
    class TransitionFadeIn extends TimedLifeController {
        ...
        private BasicLoadingGameState transition;

        public TransitionFadeIn(float lifeInSeconds, GameState leadIn, BasicLoadingGameState transition) {
            super(lifeInSeconds);
            this.leadIn = leadIn;
