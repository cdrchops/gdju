package com.gerbildrop.engine.xml;
...
import com.gerbildrop.engine.util.TypeParser;
 ...
 *
 * @author timo
 * @version $Id: DxoDoc.java,v 1.1 2007/04/04 14:27:28 vivaldi Exp $ $Copyright: Copyright
 *          2002-2005 Hotels.com, L.P. All rights reserved. $
 * @since 14Aug06
 */
public class DxoDoc {
     ...
     */
    public DxoDoc(String name, int value) {
     ...
     */
    public DxoDoc(String name, long value) {
        this(name, String.valueOf(value));
    }
     ...
     */
    public DxoDoc(String name, double value) {
        this(name, String.valueOf(value));
    }
     ...
     */
    public DxoDoc(String name, float value) {
        this(name, String.valueOf(value));
    }
     ...
     */
    public DxoDoc(String name, boolean value) {
        this(name, String.valueOf(value));
    }
     ...
     */
    public DxoDoc(String name, String value) {
     ...
     */
    public DxoDoc(Document doc, Dxo root) {
        _doc = doc;
        setRoot(root);
    }
     ...
     */
    public DxoDoc(Document doc, Element root) {
     ...
     */
    public DxoDoc(Document doc, String name) {
     ...
     */
    public DxoDoc(Document doc, String name, String value) {
     ...
     * @return
     */
    public static String toStringAll(DxoDoc doc, int[] attributes) {
     ...
     * @return
     */
    public static String removeEmptyInlineValues(String doc, boolean format) {
     ...
     * @param obj
     */
    public void setObjectFromElement(Element elem, Object obj) {
     ...
     * @param hm
     */
    public void setObjectFromElements(Object obj, Map<String, Object> hm) {
     ...
     * @param hm
     */
    public static void setObjectFromElement(Element elem, Object obj, Map<String, Object> hm) {
     ...
     * @param hm
     */
    private static void recurse(Element elem, Object parent, Object obj, Map<String, Object> hm) {
        DxoDoc.count++;
        if (DxoDoc.showDebug) {
        ...
        if (elem.hasElements()) {
            ...
            for (Object aLst : lst) {
                ...
                if (setThis && parent != null) {
                    ...
                    parent = ReflectionHelper.runMethodInvocation(parent, method, new Class[]{obj.getClass()}, new Object[]{obj});
                }
            }
     ...
     * @param obj
     */
    private static void recursiveElements(Element elem, Object obj) {
        ReflectUtil r = ReflectUtil.current();
        List lst = r.getFieldsOf(obj);
    ...
    public static DxoDoc parse(String str) {
        ...
        try {
            doc = new Document(new java.io.ByteArrayInputStream(str.getBytes()));
     ...
     * @param tmpMap
     */
    public static void recurseForMap(Element elem, Map<String, Object> tmpMap) {
        if (elem.hasElements()) {
            Elements elems = elem.getElements();
            while (elems.hasMoreElements()) {
                Element elem1 = elems.next();
     ...
     * @param tmpMap
     */
    public static void recursiveMapElement(Element elem, Map<String, Object> tmpMap) {
