 ...
 *
 * @author timo
 * @version $Id: Dxo.java,v 1.1 2007/04/04 14:27:28 vivaldi Exp $ $Copyright: Copyright 2002-2005 Hotels.com, L.P. All
 *          rights reserved. $
 * @since 14Aug06
 */
public class Dxo {
     ...
     */
    public Dxo(String name, int value) {
     ...
     */
    public Dxo(String name, long value) {
        this(name, String.valueOf(value));
    }
     ...
     */
    public Dxo(String name, double value) {
        this(name, String.valueOf(value));
    }
     ...
     */
    public Dxo(String name, float value) {
        this(name, String.valueOf(value));
    }
     ...
     */
    public Dxo(String name, boolean value) {
        this(name, String.valueOf(value));
    }
     ...
     */
    public Dxo(String name, String value) {
        this(name);
        _elem.setText(value);
    }
