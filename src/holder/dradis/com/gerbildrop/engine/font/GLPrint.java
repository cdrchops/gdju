...
//build colours for font with alpha transparency
    ...
    /**
     * Some liberties had to be taken with this method.  I could not get the glCallLists() to work, so it is done
     * manually instead.
     */
    public static void glPrint(String msg) {                                      // Custom GL "Print" Routine
        if (msg != null) {
    ...
    *
    */
    static void buildFont() {                          // Build Our Bitmap Font
