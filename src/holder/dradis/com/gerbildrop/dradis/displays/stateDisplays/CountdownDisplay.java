...
public class CountdownDisplay implements Displays {
    ...
    private void initHours(int hours, Node rootNode) {
        ...
        colon1.init("colon1", CountdownDisplay.class.getResource("/dradis/displays/clock/numbers/colon.png"), .5f);
    ...
    private void initMinutes(int minutes, Node rootNode) {
        ...
        colon2.init("colon2", CountdownDisplay.class.getResource("/dradis/displays/clock/numbers/colon.png"), .5f);
