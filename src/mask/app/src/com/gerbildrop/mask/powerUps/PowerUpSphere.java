...
public class PowerUpSphere {
    Sphere powerEnclosure;
    Sphere powerUp;
    ...
    public void create(Node rootNode, Vector3f location) {
        ...
        powerEnclosure = new Sphere("Power Up Enclosure", 50, 50, 10);

        URL enclosureTextureLoc = PowerUpSphere.class.getResource("/asTest/as_ex_lightning.png");
...
//        enclosureT.setCorrection(Texture.PERSPECTIVE);
        ...
        URL colorTextureLoc = PowerUpSphere.class.getResource("/asTest/as_ex_colors.png");
