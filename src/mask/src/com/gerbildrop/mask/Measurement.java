...
public class Measurement {
    ...
    public float getDistance(Spatial s1, Spatial s2) {
        ...
        Ray s1Tos2 = new Ray(s1Coords, s2Coords
                .subtractLocal(s1Coords).normalizeLocal());
        ...
        FloatBuffer lineBuf = BufferUtils.createFloatBuffer(new Vector3f[]{s2SurfacePos, s1SurfacePos});
