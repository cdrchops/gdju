...
//    private OpenALSoundNode music;
    ...
    public BaseModelObject(Node _rootNode, String string) {
        this(string);
...
//        initializeWeaponry();
    ...
    public void setTextureObject(final TextureObject _textureObject) {
        this.textureObject = _textureObject;
    }
    ...
    public void setAcceleration(final float _acceleration) {
    ...
    public void setAmmoCount(final int _ammoCount) {
    ...
    public void setArmed(final boolean _armed) {
        this.armed = _armed;
    }
