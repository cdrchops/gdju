...
/**
 * A simple implementation of fonts in OpenGL. All this actually does it draw a bunch of quad's when the characters for
 * the string should be. It then textures those quads with a specially created texture containing all the characters
 * from a font. The texture coordinates are chosen so that the appropriate bit of the texture is shown on each quad for
 * the characters.
 * <p/>
 * Theres a really good tool for building textures containing fonts called Bitmap Font Builder
 * (http://www.lmnopc.com/bitmapfontbuilder/)
 * <p/>
 * The tool actually produces textures containing two textures, one at the bottom and one at the top, which is what this
 * class is based on
 *
 * @author Kevin Glass
 */
public class BitmapFont {
    ...
    /**
     * Create a new font based on specific texture cut up into a specific collection of characters
     *
     ...
     */
    public BitmapFont(GlTexture texture, int characterWidth, int characterHeight) {
    ...
    /**
     * Draw a string to the screen as a set of quads textured in the appropriate way to show the string.
     *
     * @param font The index of the font to draw. 0 means the font at the top, 1 the font at the bottom.
     ...
     */
    public void drawString(int font, String text, float x, float y) {
