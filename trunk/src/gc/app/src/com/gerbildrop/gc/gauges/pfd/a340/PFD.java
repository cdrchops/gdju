...
public class PFD extends BaseGauge {
    ...
    public void display(GLAutoDrawable glAutoDrawable) {
        ...
        paintAttitudeInd(glAutoDrawable);
//        paintFMA();
...
//        paintAltitudeInd(glAutoDrawable);
    ...
    public static void fnt_printf(GLAutoDrawable glAutoDrawable, double x, double y, String value) {
        GLUtil.fnt_printf(glAutoDrawable, x, y, value);
    }

    void evalCircle(double x, double y, double r, int n, double start, double end) {
        GLUtil.evalCircle(gl, x, y, r, n, start, end);
    }
    ...
    void paintAttitudeInd(GLAutoDrawable glAutoDrawable) {
        ...
        if (bAvail) {
            ...
            for (int i = 1; i < 9; ++i) {
                ...
                gl.glEnd();
                gl.glColor3ubv(CLWhite);
                fnt_printf(glAutoDrawable, 0.320, 0.494 + (y * 0.110) - 0.027, String.valueOf(i * 10));
                fnt_printf(glAutoDrawable, 0.556, 0.494 + (y * 0.110) - 0.027, String.valueOf(i * 10));
            ...
            fnt_printf(glAutoDrawable, 0.426, 0.297 - 0.062, String.valueOf(h));
    ...
    void paintSpeedInd(GLAutoDrawable glAutoDrawable) {
        ...
        if (bAvail) {
            ...
            for (i = -4; i < 6; ++i) {
                ...
                if (h >= 0.0 && y >= 0.209 && y <= 0.776) {
                    ...
                    if (((int) (h / 10.0) & 1) == 0) {
                        fnt_printf(glAutoDrawable, 0.042, y - 0.025, String.valueOf(h));
                    }
                }
            }
            ...
            if (fY1 >= 0.224 && fY1 <= 0.761) {
                ...
                fnt_printf(glAutoDrawable, 0.195, fY1 - 0.025, "1");
            }
            ...
            if (fMach >= 0.5f) {
                ...
                fnt_printf(glAutoDrawable, 0.030, 0.150, String.valueOf(fMach));
            }
        }
    ...
    void paintHeadingInd(GLAutoDrawable glAutoDrawable) {
            ...
            for (i = -6; i < 6; ++i) {
                ...
                if (x >= 0.205 && x <= 0.700) {
                    ...
                    if ((int) (fHeading - h + (i * 5.0)) % 10 == 0) {
                        ...
                        if (h < 10.0) x += 0.0125;
                        fnt_printf(glAutoDrawable, x - 0.025, 0.045, String.valueOf(h));
                    } else {
...
//            setPaintWidth(1);
    ...
    void paintAltitudeInd(GLAutoDrawable glAutoDrawable) {
        ...
        if (bAvail) {
            ...
            for (i = -6; i < 8; ++i) {
                ...
                if (y >= 0.209 && y <= 0.776) {
                    ...
                    if (((int) h % 500) == 0) {
                        fnt_printf(glAutoDrawable, 0.757, y - 0.025, String.valueOf(h / 100.0));
                    }
                }
            }
            ...
            if (y >= 0.209 && y <= 0.776) {
                ...
                fnt_printf(glAutoDrawable, 0.757, 0.761, String.valueOf(fAutopilotAltitude));
            }
            ...
            fnt_printf(glAutoDrawable, 0.753, 0.457, String.valueOf(Math.abs((int) (fAltitude / 100.0))));
            ...
            for (i = -1; i < 3; ++i) {
                ...
                if (xy >= 0.414 && xy <= 0.554) {
                    fnt_printf(glAutoDrawable, 0.855, xy - 0.025, String.valueOf(Math.abs((int) h) % 100));
                }
            }
