 ...
 *
 * @author Joshua Slack
 * @version $Id: TestRenderQueue2.java,v 1.2 2007/04/18 21:53:29 vivaldi Exp $
 */
public class TestRenderQueue2 extends SimpleGame {
    ...
    public static void main(String[] args) {
        TestRenderQueue2 app = new TestRenderQueue2();
    ...
    protected void simpleInitGame() {
        ...
        ts.setTexture(
                TextureManager.loadTexture(
                        TestRenderQueue2.class.getResource(
